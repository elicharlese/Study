const courses = [
  ...
  },
  {
    ...
    description: 'Develop technical and business communication skills.',
    category: 'Language',
    level: 'Beginner',
    duration: '6 weeks',
  ...
  },
  {
    ...
    description: 'Understand atomic structure, reactions, and chemical bonding.',
    category: 'Chemistry',
    level: 'Beginner',
    duration: '10 weeks',
    instructor: 'Dr. Brown',
  ...
  },
  {
    ...
    description: 'Study genes, cells, and molecular processes of life.',
    category: 'Biology',
    level: 'Advanced',
    duration: '14 weeks',
    ...
    <div className="min-h-screen p-8 font-[family-name:var(--font-geist-sans)]">
      <main className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 flex flex-wrap gap-4 justify-center">
          ...
          <button className="px-4 py-2 bg-gray-100 text-gray-700 rounded-full hover:bg-gray-200">Chemistry</button>
          <button className="px-4 py-2 bg-gray-100 text-gray-700 rounded-full hover:bg-gray-200">Biology</button>
        </div>
